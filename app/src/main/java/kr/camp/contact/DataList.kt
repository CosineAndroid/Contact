...
fun contactList(): MutableList<ContactData> {
    return mutableListOf(
        ContactData(
            profileImageDrawbleId = R.drawable.ms,
            name = "Microsoft",
            ...
            profileImageDrawbleId = R.drawable.apple,
            name = "Apple",
            phoneNumber = "080–330–8877",
            website = "https://www.apple.com/kr/",
            memo = "Apple은 1976년 4월 1일에 설립된 미국의 전자제품 제조사로, \n 세부 업종은 하드웨어, 소프트웨어, 온라인 서비스 등의 \n 디자인·설계, 개발, 제조·제작[9] 및 판매업이다."
        ),ContactData(
            profileImageDrawbleId = R.drawable.google,
            name = "Google",
            phoneNumber = "080-234-0051",
            website = "https://www.google.co.kr/?hl=ko",
            memo = "구글은 알파벳 산하의 종합 IT 기업으로, \n 역사상 전 세계 최대의 인터넷 기업중 하나이다."
        ),ContactData(
            profileImageDrawbleId = R.drawable.amazon,
            name = "Amazon",
            phoneNumber = "1-800-280-4331",
            website = "https://www.amazon.com/",
            memo = "아마존닷컴은 미국의 종합 인터넷 플랫폼이다. \n 세계 최대 규모의 온라인 쇼핑몰과 클라우드 컴퓨팅 서비스를 제공하고 있다."
        ),ContactData(
            profileImageDrawbleId = R.drawable.meta,
            name = "Meta",
        ...
        ,ContactData(
            profileImageDrawbleId = R.drawable.tesla ,
            name = "Tesla",
